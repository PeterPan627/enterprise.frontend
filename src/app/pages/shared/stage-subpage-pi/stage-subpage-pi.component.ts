...
import { SalesStagePiCollection } from '../../../@core/interfaces/common/SalesStage/SalesStagePiCollection';
...
@Component({
    selector: 'ngx-stage-subpage-pi',
    templateUrl: './stage-subpage-pi.component.html',
    styleUrls: ['./stage-subpage-pi.component.scss'],
})
export class StageSubPagePiComponent implements OnInit {
    ...
    public stages: SalesStagePiCollection;
    public end: boolean = false;
    constructor(private toastrService: NbToastrService) {
        this.stages = new SalesStagePiCollection(
            '1 New Lead',
            '2 Retained',
            '3 Treating',
            '4 Request Medical Records. Bills',
            '5 Drafting Demand',
            '6 Attorney Review',
            '6.1 Client Rule 11 Review Confirm',
            '6.2 Demand Sent',
            '6.3 Pre-Lit Negotiations',
            '6.4 Pre-Lit Offer Made',
            '6.5 Complaint Drafting',
            '6.7 Complaint Filed',
            ...
            '7.5 Dismissed Case',
            '8 Future Client',
            '9 Settled Case Closed',
            '9.5 SOA Cancelled',
            '9.7 DROPPED Cancelled',
            'X Dead Lead',
        );
    }
    ...
    init() {
        this.service.getSalesStage(this.opportunityId, TransType.Law_Pi)
            ...
            .subscribe((s: any) => {
                ...
                this.stages.stage6_4 = s.stage6_4;
                ...
                this.stages.stage9_5 = s.stage9_5;
                this.stages.stage9_7 = s.stage9_7;
            });
    }
    ...
    private setAstage() {
        ...
        } else if (!isNullOrUndefined(this.stages.stage6_4.date)) {
            this.stages.AStage = this.stages.stage6_4.stageName;
        ...
        } else if (!isNullOrUndefined(this.stages.stage9_5.date)) {
            this.stages.AStage = this.stages.stage9_5.stageName;
        } else if (!isNullOrUndefined(this.stages.stage9_7.date)) {
            this.stages.AStage = this.stages.stage9_7.stageName;
        }
