...
@Component({
    selector: 'ngx-afg-preapplication',
    templateUrl: './afg-preapplication.component.html',
    styleUrls: ['./afg-preapplication.component.scss'],
})
export class AFGPreApplicationTabComponent implements OnInit {
    contactName: '';
    form: FormGroup;
    users: User[] = [];
