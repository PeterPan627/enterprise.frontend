...
@Component({
    selector: 'ngx-p65-lam',
    templateUrl: './p65-lam.component.html',
    styleUrls: ['./p65-lam.component.scss'],
})
export class P65LamTabComponent implements OnInit {
    ...
    ngOnInit() {
        ...
        this.data = this.service.getLawAndMotionP65(this.id).pipe(takeUntil(this.unsubscribe$));
    ...
    setFormValues(form: FormGroup, data: any, service: OpportunityService) {
        form.setValue({
            ...
            Conord20: getNullableDateValue(data.Conord20, ''),
            ...
            ForeclosureDate1: getNullableDateValue(data.ForeclosureDate1, ''),
            ...
            Conord10: getNullableDateValue(data.Conord10, ''),
            Conord11: getNullableDateValue(data.Conord11, ''),
            Conord13: getNullableDateValue(data.Conord13, ''),
            ...
            Conord14: getNullableDateValue(data.Conord14, ''),
            Conord15: getNullableDateValue(data.Conord15, ''),
            ...
            Conord16: getNullableDateValue(data.Conord16, ''),
            Conord17: getNullableDateValue(data.Conord17, ''),
            ...
            Conf14: getNullableDateValue(data.Conf14, ''),
            ...
            ConDueBy14: getNullableDateValue(data.ConDueBy14, ''),
